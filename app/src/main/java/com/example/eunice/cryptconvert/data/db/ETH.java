...
public class ETH implements Serializable, Parcelable
{
    ...
    @Expose
    private Double sGD;
    public final static Parcelable.Creator<ETH> CREATOR = new Creator<ETH>() {
        ...
        public ETH[] newArray(int size) {
            ...
            ;
    private final static long serialVersionUID = 1663709716131824060L;
     ...
     * @param bRL
     */
    public ETH(Double uSD, Double eUR, Double nGN, Double aRS, Double aUD, Double gBP, Double jPY, Double iLS, Double cHF, Double qAR, Double gHS, Double aED, Double sAR, Double zAR, Double tRY, Double iNR, Double bRL, Double cAD, Double cNY, Double sGD) {
        super();
        this.uSD = uSD;
        this.eUR = eUR;
        this.nGN = nGN;
